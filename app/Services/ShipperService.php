...
class ShipperService
{
    ...
    public function getPricingDomestic($body, $rate_type = null)
    {
        return $this->exSave(function () use ($body, $rate_type) {
            ...
            Log::info(json_encode($body));
            $ress = $this->client->request('POST', $this->base_url . '/pricing/domestic/' . $rate_type, [
                'body' => json_encode($body),
                'headers' => [
                    'Accept' => 'application/json',
                    'Content-Type' => 'application/json',
    ...
    public function locationCountries()
    {
        return $this->exSave(function () {
            ...
            $ress = $this->client->request('GET', $this->base_url . '/location/countries?' . $params, [
                'headers' => [
                    'Accept' => 'application/json',
                    'Content-Type' => 'application/json',
                    'X-API-Key' =>  $this->api_key,
    ...
    public function locationProvinces($country_id)
    {
        return $this->exSave(function () use ($country_id) {
            $params = http_build_query(request()->all());
            $ress = $this->client->request('GET', $this->base_url . '/location/country/' . $country_id . '/provinces?' . $params, [
                'headers' => [
                    'Accept' => 'application/json',
                    'Content-Type' => 'application/json',
                    'X-API-Key' =>  $this->api_key,
    ...
    public function locationCities($province_id)
    {
        return $this->exSave(function () use ($province_id) {
            $params = http_build_query(request()->all());
            $ress = $this->client->request('GET', $this->base_url . '/location/province/' . $province_id . '/cities?' . $params, [
                'headers' => [
                    'Accept' => 'application/json',
                    'Content-Type' => 'application/json',
                    'X-API-Key' =>  $this->api_key,
    ...
    public function locationSuburbs($city_id)
    {
        return $this->exSave(function () use ($city_id) {
            $params = http_build_query(request()->all());
            $ress = $this->client->request('GET', $this->base_url . '/location/city/' . $city_id . '/suburbs?' . $params, [
                'headers' => [
                    'Accept' => 'application/json',
                    'Content-Type' => 'application/json',
                    'X-API-Key' =>  $this->api_key,
    ...
    public function locationAreas($suburb_id)
    {
        return $this->exSave(function () use ($suburb_id) {
            $params = http_build_query(request()->all());
            $ress = $this->client->request('GET', $this->base_url . '/location/suburb/' . $suburb_id . '/areas?' . $params, [
                'headers' => [
                    'Accept' => 'application/json',
                    'Content-Type' => 'application/json',
                    'X-API-Key' =>  $this->api_key,
    ...
    public function timeslot()
    {
        return $this->exSave(function () {
            $params = http_build_query(request()->all());
            $ress = $this->client->request('GET', $this->base_url . '/pickup/timeslot?' . $params, [
                'headers' => [
                    'Accept' => 'application/json',
                    'Content-Type' => 'application/json',
                    'X-API-Key' =>  $this->api_key,
